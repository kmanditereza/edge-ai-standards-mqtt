...
* Raw data topic: site/area/line/cell/node/device/raw
    * Metrics published each second, including: RPMs, temperature, pressure
* Functional "inference" topic: site/area/line/cell/node/device/inference/k8cjaqdcgz/1.0.0
    * Metrics published each second: motor_status (normal, stressed, highly stressed), predicted_lifespan
* Functional "insight" topic: site/area/line/cell/node/device/insight/maintenance_required
    * Metric published each minute: Boolean of whether maintenance is required based on motor_status and predicted_lifespan metrics generated by a machine learning model
